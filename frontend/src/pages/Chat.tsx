	...
	const sendMessage = async () => {
		...
		try {
			...
			const res = await axios.post(
				...
				{
					query: input,
					conversation_id: 1, // TODO: Handle dynamic conversation ID
				},
				{
	...
	return (
		<div className="flex h-screen bg-gray-900 text-white">
			...
			<div className="w-64 bg-gray-800 p-4 flex flex-col border-r border-gray-700">
				...
				<button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 p-3 rounded-lg mb-4 transition-colors">
					<Plus size={20} />
					<span>New Chat</span>
				</button>
				<div className="flex-1 overflow-y-auto">
					...
					{/* Mock History */}
					<div className="flex items-center gap-2 p-2 hover:bg-gray-700 rounded cursor-pointer text-gray-300">
